...
///   0 = Dashboard, 1 = Feed, 2 = Study, 3 = Polls,
...
class AppShell extends ConsumerWidget {
  ...
  static const _study = _Dest(2, Icons.menu_book_outlined, Icons.menu_book, 'Study');
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final destinations = role == 'rep'
        ? const [_dashboard, _feed, _study, _polls, _manage, _profile]
        : const [_dashboard, _feed, _study, _polls, _profile];
...
class _AdminShell extends StatelessWidget {
  ...
  static const _left = [AppShell._dashboard, AppShell._feed, AppShell._study];
